...
As of 2026-05-30: all eleven v0.1 phases (0 through 10) are merged to `main`; v0.2 Phase 1 (real-model validation) is merged via PR #30; v0.2 Phase 2 (backup / restore) is merged via PR #32; v0.2 Phase 3 (scheduled curation daemon) is merged via PR #33 — ships ADR-012; v0.2 Phase 4 (ingestion automation / inbox) is merged via PR #34. Compendium v0.1 is feature-complete; v0.2 build is underway.
...
- **v0.2 Phases 5–8** — not started; see [docs/COMPENDIUM_V0.2_BUILD.md](docs/COMPENDIUM_V0.2_BUILD.md).
