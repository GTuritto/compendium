...
echo "  Tag + release:  automatic — CI tags v$VERSION and publishes the"
echo "                  release once this VERSION bump merges to main and the"
echo "                  smoke gate is green. No manual 'git tag' needed."
